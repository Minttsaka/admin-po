...
import { Newspaper, PlusCircleIcon } from 'lucide-react'

export default function MarketSideBar() {
  return (
    <div>
       <div className="flex flex-col bg-[#051d05] rounded-e-2xl gap-2">
          <div className="flex items-center">
          <nav className="flex flex-col space-y-2 shadow-2xl shadow-black rounded-e-2xl text-white p-4">
        <div>
          <h2 className="mb-2 text-sm font-medium text-gradient from-[red] to-black">Articles</h2>
          <ul className="grid gap-1">
            ...
            <li>
              <Link
                ...
                prefetch={false}
              >
                <Newspaper className="h-4 w-4 text-gradient from-accent to-accent-foreground" />
                Articles
              </Link>
            </li>
            <li>
              <Link
                href="/observer/media-news/create"
                ...
                prefetch={false}
              >
                <PlusCircleIcon className="h-4 w-4 text-gradient from-secondary to-muted" />
                Create
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="grid gap-1">
            <li>
              <Link
                href="/observer/media-news/events"
            ...
            <li>
              <Link
                ...
                prefetch={false}
              >
                <SettingsIcon className="h-4 w-4 text-gradient from-primary to-secondary" />
                Manage
              </Link>
            </li>
          </ul>
        ...
        <div>
          <h2 className="mb-2 text-sm font-medium text-gradient from-muted-foreground to-muted-foreground/80">Vacancy</h2>
          <ul className="grid gap-1">
            <li>
              <Link
                href="/observer/media-news/vacancy"
                className="flex hover:bg-blue-200 hover:shadow-md items-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-gradient-to-r from-accent to-accent-foreground hover:text-gradient from-accent to-accent-foreground"
                prefetch={false}
              >
            ...
            <li>
              <Link
                ...
                prefetch={false}
              >
                <SettingsIcon className="h-4 w-4 text-gradient from-secondary to-muted" />
                Manage
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="grid gap-1">
            <li>
              <Link
                href="/observer/media-news/quotes"
                className="flex hover:bg-blue-200 hover:shadow-md items-center gap-2 rounded-md px-3 py-2 text-sm font-medium transition-colors hover:bg-gradient-to-r from-accent to-accent-foreground hover:text-gradient from-accent to-accent-foreground"
                prefetch={false}
              >
                <Newspaper className="h-4 w-4 text-gradient from-accent to-accent-foreground" />
