...
export default function NewsRightBar() {
  return (
    <div>
      <div className="w-[20vw] flex flex-col gap-1">
          <Card className="flex flex-col w-full gap-4 border bg-[purple] text-white h-fit shadow p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  
                  <div>
                  <div className="flex gap-3 items-center justify-center rounded-full bg-primary/10 p-2 text-primary">
                ...
                <div className="flex  h-8 w-8 items-center justify-center rounded-full bg-primary/10 p-2 text-primary">
                  <ChevronUpIcon className="h-4 w-4 " />
                </div>
              </div>
              <div className="text-sm text-muted-foreground">
                <span className="font-medium text-primary text-green-300">+5.2%</span> from last month
              </div>
            </Card>
            <Card className="flex flex-col w-full gap-4 border text-gray-500 bg-white h-fit shadow p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div>
                  <div className="flex gap-3 items-center justify-center rounded-full bg-primary/10 p-2 text-primary">
            ...
            <Card className="flex flex-col w-full gap-4 border-t-blue-500 border-t-4 text-gray-500 bg-white h-fit shadow p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div>
                  <div className="flex gap-3 items-center justify-center rounded-full bg-primary/10 p-2 text-primary">
